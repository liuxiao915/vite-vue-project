<template>
  <el-container class="panel-container">
          ...
          <template v-if="!!designer.selectedWidget && !designer.selectedWidget.category">
            <el-form :model="optionModel" size="small" label-position="left" label-width="120px" class="setting-form" @submit.prevent>
              <el-collapse v-model="widgetActiveCollapseNames" class="setting-collapse">
                ...
                <el-collapse-item name="3" v-if="showCollapse(eventProps)" :title="i18nt('designer.setting.eventSetting')">
    ...
    <div v-if="showWidgetEventDialogFlag" class="" v-drag="['.drag-dialog.el-dialog', '.drag-dialog .el-dialog__header']">
      <el-dialog :title="i18nt('designer.setting.editWidgetEventHandler')" v-model="showWidgetEventDialogFlag" :show-close="true" class="drag-dialog small-padding-dialog" append-to-body :close-on-click-modal="false" :close-on-press-escape="false" :destroy-on-close="true">
...
import { propertyRegistered } from "@/views/systemTools/formDesign11/components/form-designer/setting-panel/propertyRegister";
