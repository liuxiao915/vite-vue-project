      ...
      <el-dialog :title="i18nt('designer.toolbar.preview')" v-model="showPreviewDialogFlag" :show-close="true" :close-on-click-modal="false" :close-on-press-escape="false" center :destroy-on-close="true" :append-to-body="true" class="drag-dialog small-padding-dialog" width="75%" :fullscreen="false">
        <div>
          <div class="form-render-wrapper">
            <VFormRender ref="preForm" :form-json="formJson" :form-data="testFormData" :preview-state="true" :option-data="testOptionData" @myEmitTest="onMyEmitTest" @appendButtonClick="testOnAppendButtonClick" @buttonClick="testOnButtonClick" @formChange="handleFormChange">
            </VFormRender>
          </div>
        </div>
        <template #footer>
...
} from "@/views/systemTools/formDesign11/utils/util"
import i18n from '@/views/systemTools/formDesign11/utils/i18n'
import { generateCode } from "@/views/systemTools/formDesign11/utils/code-generator"
import { genSFC } from "@/views/systemTools/formDesign11/utils/sfc-generator"
