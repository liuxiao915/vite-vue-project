//import { vfApp } from '@/views/systemTools/formDesign11/utils/create-app'
import * as PERegister from '@/views/systemTools/formDesign11/components/form-designer/setting-panel/propertyRegister'
import * as PEFactory from '@/views/systemTools/formDesign11/components/form-designer/setting-panel/property-editor-factory.jsx'

import CardWidget from '@/extension/samples/card/card-widget'
import CardItem from '@/extension/samples/card/card-item'
import {registerCWGenerator} from '@/views/systemTools/formDesign11/utils/sfc-generator'
...
import {registerFWGenerator} from '@/views/systemTools/formDesign11/utils/sfc-generator'
